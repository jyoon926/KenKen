angular.module("kenkenApp", []).service("KenkenService", function () {
    ...
    function makeCage(id, a, i, j, ops) {
        ...
        // two cells: sub and div are possible, but div only if cells divide evenly
            ...
            var x = cell(a, cage.cells[0]).ans,
                y = cell(a, cage.cells[1]).ans;
            if (~ops.indexOf("/")) {
        ...
        // more than two cells: div and sub not allowed
            ...
            cage.cells.forEach(function (c) {
                ...
                total =
                    op == "+" ? total + ans : op == "x" ? total * ans : "ERR!";
            });
        }
        cage.op = op;
        cage.total = total;
